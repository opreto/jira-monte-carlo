            ...
            for age in ages:
                if age <= thresholds["fresh"]:
                    colors.append(
                        self.chart_colors.get(
                            "success",
                            self.chart_colors.get("high_confidence", "#00A86B"),
                        )
                    )
                    ...
                    colors.append(
                        self.chart_colors.get(
                            "warning",
                            self.chart_colors.get("medium_confidence", "#FFA500"),
                        )
                    )
                    ...
                    fig.add_shape(
                        ...
                        line=dict(
                            color=self.chart_colors.get(
                                "error",
                                self.chart_colors.get("low_confidence", "#DC143C"),
                            ),
                            width=3,
                            dash="dash",
                        ),
            ...
            go.Indicator(
                ...
                gauge={
                    ...
                    "steps": [
                        {
                            "range": [0, 60],
                            "color": self._get_color_with_alpha("error", 0.1),
                        },
                        {
                            "range": [60, 80],
                            "color": self._get_color_with_alpha("warning", 0.1),
                        },
                        {
                            "range": [80, 100],
                            "color": self._get_color_with_alpha("success", 0.1),
                        },
                    ],
                    "threshold": {
