...
from ..domain.forecasting import (
    ForecastingModel, ForecastingModelFactory, ModelInfo, 
    ModelType, ModelConfiguration, MonteCarloConfiguration
)
...
class DefaultModelFactory(ForecastingModelFactory):
    ...
    def create(self,
              ...
              config: Optional[ModelConfiguration] = None) -> ForecastingModel:
