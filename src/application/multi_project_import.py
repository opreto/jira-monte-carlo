...
class ProcessMultipleDataSourcesUseCase:
    ...
    def _process_single_file(self,
                            ...
                            config_repo: ConfigRepository) -> ProjectData:
        ...
        velocity_metrics = velocity_use_case.execute(
            lookback_sprints=velocity_config['lookback_sprints'],
            velocity_field=velocity_config['velocity_field']
        )
    ...
    def _calculate_aggregated_metrics(self, 
        ...
        combined_velocity = sum(
            p.velocity_metrics.average for p in projects 
