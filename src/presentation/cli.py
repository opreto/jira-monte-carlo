...
def main(
    ...
    # Parse lookback_sprints value
    lookback_sprints_value = -1  # Default to auto-detection
    if lookback_sprints.lower() != "auto":
        try:
            ...
            console.print(
                f"[red]Error: Invalid lookback-sprints value '{lookback_sprints}'. "
                f"Use a positive number or 'auto'.[/red]"
            )
            return
