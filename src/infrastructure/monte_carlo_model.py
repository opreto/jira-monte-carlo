...
from ..domain.forecasting import (
    ForecastingModel, ForecastResult, ModelInfo, ModelType,
    PredictionInterval, ModelConfiguration, MonteCarloConfiguration
)
...
class MonteCarloModel(ForecastingModel):
    ...
    def forecast(self,
                ...
                config: ModelConfiguration) -> ForecastResult:
    ...
    def validate_inputs(self,
                       remaining_work: float,
                       velocity_metrics: VelocityMetrics) -> List[str]:
    ...
    def _run_simulations(self,
                        remaining_work: float,
                        velocity_metrics: VelocityMetrics,
                        config: MonteCarloConfiguration) -> List[float]:
    ...
    def _calculate_prediction_intervals(self,
                                      completion_sprints: List[float],
                                      confidence_levels: List[float]) -> List[PredictionInterval]:
    ...
    def _calculate_probability_distribution(self,
                                          completion_sprints: List[float]) -> Dict[int, float]:
        ...
        distribution = {
            sprints: count / total 
            for sprints, count in sprint_counts.items()
        }
