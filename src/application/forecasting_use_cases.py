...
from ..domain.forecasting import (
    ForecastingModel, ForecastResult, ModelConfiguration,
    ForecastingModelFactory, ModelType
)
...
class CompareForecastModelsUseCase:
    ...
    def execute(self,
                remaining_work: float,
                velocity_metrics: VelocityMetrics,
                model_types: Optional[list[ModelType]] = None) -> dict[ModelType, ForecastResult]:
        """
