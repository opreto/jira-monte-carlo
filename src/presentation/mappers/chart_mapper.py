...
class ChartMapper:
    ...
    def create_probability_distribution_chart(
        ...
        # Create layout
        layout = {
            "title": {"text": "Probability Distribution", "font": {"size": 18}},
            "xaxis": {"title": "Number of Sprints", "gridcolor": "#e5e5e5"},
            "yaxis": {
                "title": "Probability (%)",
                "gridcolor": "#e5e5e5",
                "tickformat": ".1%",
    ...
    def create_confidence_intervals_chart(
        ...
        layout = {
            "title": {"text": "Confidence Intervals", "font": {"size": 18}},
            "xaxis": {"title": "Sprints to Complete", "gridcolor": "#e5e5e5"},
            "yaxis": {"title": "Confidence Level", "gridcolor": "#e5e5e5"},
            "plot_bgcolor": "rgba(0,0,0,0)",
            "paper_bgcolor": "rgba(0,0,0,0)",
        ...
        if 0.85 in percentiles and 0.5 in percentiles:
            ...
            insights.append(
                f"Range: {spread:.1f} sprints between optimistic and conservative"
            )
    ...
    def create_velocity_trend_chart(
        self, historical_data: HistoricalData, velocity_metrics: VelocityMetrics
    ) -> ChartViewModel:
        ...
        layout = {
            "title": {"text": "Historical Velocity Trend", "font": {"size": 18}},
            "xaxis": {"title": "Sprint", "gridcolor": "#e5e5e5"},
            "yaxis": {"title": "Velocity (Story Points)", "gridcolor": "#e5e5e5"},
            "plot_bgcolor": "rgba(0,0,0,0)",
            "paper_bgcolor": "rgba(0,0,0,0)",
        ...
        insights = []
        insights.append(
            f"Average velocity: {velocity_metrics.average:.1f} points/sprint"
        )
        if velocity_metrics.trend:
    ...
    def create_health_gauge_chart(
        ...
        data = {
            ...
            "value": score,
            "title": {"text": "Process Health Score", "font": {"size": 24}},
            "delta": {
                "reference": 75,
    ...
    def create_aging_chart(self, aging_analysis: AgingAnalysis) -> ChartViewModel:
        ...
        layout = {
            "title": {"text": "Work Item Age Distribution", "font": {"size": 18}},
    ...
    def create_wip_by_status_chart(self, wip_analysis: WIPAnalysis) -> ChartViewModel:
        ...
        layout = {
            "title": {"text": "Work In Progress by Status", "font": {"size": 18}},
            "xaxis": {"title": "Status", "gridcolor": "#e5e5e5"},
            "yaxis": {"title": "Number of Items", "gridcolor": "#e5e5e5"},
            "plot_bgcolor": "rgba(0,0,0,0)",
            "paper_bgcolor": "rgba(0,0,0,0)",
    ...
    def create_sprint_completion_chart(
        ...
        layout = {
            "title": {"text": "Sprint Completion Trend", "font": {"size": 18}},
            "xaxis": {"title": "Sprint", "gridcolor": "#e5e5e5"},
            "yaxis": {
