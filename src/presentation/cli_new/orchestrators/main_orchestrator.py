...
from ..commands import CommandResult, CompositeCommand
...
class MainOrchestrator:
    ...
    def execute_full_workflow(self, args) -> CommandResult:
        ...
        workflow = CompositeCommand(
            name="full_workflow", description="Complete Sprint Radar workflow"
        )
    ...
    def execute_multi_project(self, args, csv_paths: List[str]) -> CommandResult:
        ...
        return CommandResult(
            success=False, message="Multi-project orchestration not yet implemented"
        )
    ...
    def execute_scenario_comparison(self, args) -> CommandResult:
        ...
        workflow = CompositeCommand(
            name="scenario_workflow", description="Velocity scenario comparison"
        )
