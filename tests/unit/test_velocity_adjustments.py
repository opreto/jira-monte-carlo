...
class TestTeamChange:
    ...
    def test_team_addition_linear_ramp(self):
        ...
        change = TeamChange(sprint=4, change=1, ramp_up_sprints=4, productivity_curve=ProductivityCurve.LINEAR)
    ...
    def test_exponential_ramp_up(self):
        ...
        change = TeamChange(sprint=1, change=1, ramp_up_sprints=3, productivity_curve=ProductivityCurve.EXPONENTIAL)
    ...
    def test_step_productivity_curve(self):
        ...
        change = TeamChange(sprint=1, change=1, ramp_up_sprints=4, productivity_curve=ProductivityCurve.STEP)
