...
class ReportController(Controller[ReportRequest, ReportResponse]):
    ...
    def handle(self, request: ReportRequest) -> ReportResponse:
        ...
        try:
            ...
            response = ReportResponse(
                ...
                health_score=report_vm.health_score.overall_score
            ...
            return ReportResponse(success=False, report_path=Path(""), errors=[str(e)])
    ...
    def _create_metric_cards(self) -> List[MetricCardViewModel]:
        ...
        return [
            ...
            MetricCardViewModel(
                label="50% Confidence", value="6", unit="sprints", color="info"
            ),
            MetricCardViewModel(
                label="85% Confidence", value="8", unit="sprints", color="warning"
            ),
        ]
    ...
    def _extract_health_insights(self, report_vm: ReportViewModel) -> List[str]:
    ...
    def _extract_health_recommendations(self, report_vm: ReportViewModel) -> List[str]:
