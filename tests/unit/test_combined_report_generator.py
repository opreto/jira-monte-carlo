...
from src.domain.velocity_adjustments import ScenarioComparison, VelocityAdjustment, VelocityScenario
...
class TestCombinedReportGenerator:
    ...
    def test_combined_banner_html(self):
        ...
        scenario = VelocityScenario(
            name="Test",
            adjustments=[
                VelocityAdjustment(sprint_start=1, sprint_end=3, factor=0.8, reason="holidays")
            ],
            team_changes=[]
        )
