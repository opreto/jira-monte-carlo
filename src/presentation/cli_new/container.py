...
class CLIContainer:
    ...
    def _initialize_repositories(self):
        ...
        self._instances["config_repo"] = FileConfigRepository(
            Path.home() / ".sprint-radar"
        )
    ...
    def _initialize_services(self):
        ...
        self._instances["style_service"] = StyleService(
            theme_repository=theme_repo, style_generator=style_generator
        )
    ...
    def _initialize_use_cases(self):
        ...
        self._instances["velocity_adjustment_use_case"] = (
            ApplyVelocityAdjustmentsUseCase()
        )
        self._instances["velocity_scenario_use_case"] = CreateVelocityScenarioUseCase()
        self._instances["scenario_comparison_use_case"] = (
            GenerateScenarioComparisonUseCase()
        )
    ...
    def create_command_context(self, args: Any) -> Any:
